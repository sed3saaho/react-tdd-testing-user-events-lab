...
test("the page shows information the user types into the name and email address form fields", () => {
  ...
  userEvent.type(fullName, "username usersname");
  userEvent.type(emailAddress, "usernameusersname@email.com");

  expect(fullName).toHaveValue("username usersname");
  expect(emailAddress).toHaveValue("usernameusersname@email.com");
});
...
test("a message is displayed when the user clicks the Submit button", () => {
  ...
  expect(
    screen.getByText(
      "Thanks username usersname! You are signed up for these newsletters:"
    )
  ).toBeInTheDocument();
